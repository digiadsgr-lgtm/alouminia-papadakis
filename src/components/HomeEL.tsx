        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} className="md:col-span-2">
               <Link href="/el/services/koufomata-alouminiou-rethymno" className="glass-panel p-10 lg:p-14 relative overflow-hidden group hover:border-red/30 transition-all block text-navy h-full">
             ...
             <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ delay: 0.1 }}>
               <Link href="/el/services/pergoles-rethymno-kriti" className="glass-panel p-10 hover:border-red/30 hover:shadow-2xl transition-all block group text-navy flex flex-col justify-between h-full bg-white">
                 <div>
             ...
             <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ delay: 0.2 }}>
               <Link href="/el/services/portes-asfaleias-rethymno" className="glass-panel p-10 hover:border-red/30 hover:shadow-2xl transition-all block group text-navy flex flex-col justify-between h-full bg-white">
                 <div>
             ...
             <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ delay: 0.3 }} className="md:col-span-2">
               <Link href="/el/services/sidiros-kataskeves-rethymno" className="glass-panel p-10 lg:p-14 hover:border-red/30 transition-all block group text-navy bg-white">
