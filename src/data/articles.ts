export const articles = [
  {
    ...
    "faqEL": [
      {
        "q": "Χρειάζεται άδεια η βιοκλιματική πέργκολα;",
        "a": "Συνήθως απαιτείται έγκριση εργασιών μικρής κλίμακας, μια σχετικά απλή διαδικασία στην οποία σας καθοδηγούμε πλήρως."
      },
      {
        "q": "Αντέχει στους ανέμους της Κρήτης;",
        "a": "Ναι, γίνεται ειδική στατική μελέτη και τοποθετούνται αισθητήρες ανέμου που ανοίγουν τις περσίδες για προστασία σε ακραία μποφόρ."
      },
      {
        "q": "Μπορεί να κλείσει περιμετρικά;",
        "a": "Βεβαίως. Μπορούμε να προσθέσουμε γυάλινες συρόμενες πλευρές (sliding glass doors) ή κάθετα συστήματα σκίασης (zip screens)."
      },
      {
        "q": "Σε πόσο χρόνο τοποθετείται;",
        "a": "Η κατασκευή στη μονάδα μας διαρκεί 2-4 εβδομάδες, ενώ η τοποθέτηση στον χώρο σας ολοκληρώνεται συνήθως σε 1-2 ημέρες."
      }
    ],
    "faqEN": [
      {
        "q": "Does a bioclimatic pergola require a building permit?",
        "a": "Usually a small-scale works approval is required, a relatively simple process which we can guide you through."
      },
      {
        "q": "Can it withstand the high winds in Crete?",
        "a": "Yes, it is structurally engineered and equipped with wind sensors that automatically open the louvers for protection during extreme winds."
      },
      {
        "q": "Can it be enclosed on the sides?",
        "a": "Absolutely. We can add sliding glass doors or vertical shading systems (zip screens) to fully enclose the space."
      },
      {
        "q": "How long does installation take?",
        "a": "Fabrication at our facility takes 2-4 weeks, and on-site installation is typically completed in 1-2 days."
      }
    ],
  ...
  },
  {
    ...
    "date": "2026-07-01",
    "dateModified": "2026-07-11",
    "image": "/images/koufomata_epaggelmatikos_xouros_1776111867162.webp",
    "relatedSlugs": [
    ...
    "faqEL": [
      {
        "q": "Μπορώ να αλλάξω μόνο τα κουφώματα με το Εξοικονομώ 2026;",
        "a": "Η αλλαγή κουφωμάτων μετράει σημαντικά, αλλά το πρόγραμμα απαιτεί συνολική αναβάθμιση του ακινήτου κατά συγκεκριμένες ενεργειακές κατηγορίες. Στις περισσότερες περιπτώσεις συνδυάζεται με μία ακόμη παρέμβαση (π.χ. θερμοσίφωνας ή μόνωση). Ο ενεργειακός επιθεωρητής θα σας καθοδηγήσει."
      },
      {
        "q": "Επιδοτούνται τα κουφώματα σε εξοχική κατοικία;",
        "a": "Το πρόγραμμα αφορά κατά κανόνα την κύρια κατοικία. Ελέγξτε τον επίσημο οδηγό του κύκλου όταν δημοσιευθεί."
      },
      {
        "q": "Πόσο κοστίζει η αντικατάσταση κουφωμάτων πριν την επιδότηση;",
        "a": "Πανελλαδικά, μια τυπική κατοικία κινείται ενδεικτικά στα 4.000–7.500 € ανάλογα με τα τετραγωνικά των ανοιγμάτων και τη σειρά. Με επιδότηση 50–80%, η τελική επιβάρυνση μειώνεται δραστικά."
      },
      {
        "q": "Αναλαμβάνετε όλη τη διαδικασία;",
        "a": "Αναλαμβάνουμε το τεχνικό σκέλος: επιμέτρηση, προσφορά με πλήρεις προδιαγραφές συμβατές με το πρόγραμμα, κατασκευή στη μονάδα μας στο Ρέθυμνο και τοποθέτηση. Συνεργαζόμαστε με τον μηχανικό/σύμβουλό σας για τον φάκελο."
      }
    ],
    "faqEN": [
      {
        "q": "Can I replace only the windows under Exoikonomo 2026?",
        "a": "Window replacement counts significantly, but the programme requires the property to climb a set number of energy classes overall. In most cases it is combined with one more intervention (e.g. a solar water heater or insulation). Your energy inspector will guide you."
      },
      {
        "q": "Does the programme cover holiday homes?",
        "a": "As a rule it covers primary residences only. Check the official guide of the round once published."
      },
      {
        "q": "What does window replacement cost before the subsidy?",
        "a": "Nationally, a typical home ranges indicatively between €4,000–7,500 depending on opening sizes, profile series and glazing. With a 50–80% subsidy, the net cost drops dramatically."
      },
      {
        "q": "Do you handle the whole process?",
        "a": "We handle the technical side: on-site measurement, a specification-complete quotation compatible with the programme, fabrication at our production facility in Rethymno, and installation. We coordinate with your engineer or consultant on the application file."
      }
    ],
  ...
  },
  {
    ...
    "date": "2026-07-01",
    "dateModified": "2026-07-11",
    "image": "/images/aluminum_windows_1776112108865.webp",
    "relatedSlugs": [
      "exoikonomo-2026-koufomata-kriti",
      "times-koufomata-alouminiou-odigos-kostous"
    ],
    ...
    "faqEL": [
      {
        "q": "Αξίζει η αναβάθμιση αν έχω κουφώματα 15ετίας;",
        "a": "Κουφώματα προ του 2010 σπάνια έχουν ουσιαστική θερμοδιακοπή. Η εξοικονόμηση 30–50% σε θέρμανση/ψύξη κάνει την απόσβεση ρεαλιστική σε 5–8 χρόνια — ταχύτερα με επιδότηση."
      },
      {
        "q": "Ανοιγόμενα ή συρόμενα;",
        "a": "Τα ανοιγόμενα προσφέρουν καλύτερη στεγάνωση και θερμομόνωση· τα συρόμενα κερδίζουν σε χώρο και θέα. Συχνά η βέλτιστη λύση είναι συνδυασμός ανά χώρο."
      },
      {
        "q": "Πόσο διαρκεί η τοποθέτηση;",
        "a": "Σε τυπική κατοικία, 1–3 ημέρες, με αποξήλωση των παλιών."
      },
      {
        "q": "Κάνετε έργα εκτός Ρεθύμνου;",
        "a": "Ναι — αναλαμβάνουμε έργα σε όλη την Κρήτη, από τη μονάδα παραγωγής μας στο Ρέθυμνο."
      }
    ],
    "faqEN": [
      {
        "q": "Is upgrading worth it if my frames are 15 years old?",
        "a": "Frames from before 2010 rarely have a meaningful thermal break. A 30–50% saving on heating/cooling makes payback realistic within 5–8 years — faster with a subsidy."
      },
      {
        "q": "Casement or sliding?",
        "a": "Casement (hinged) systems seal and insulate better; sliding systems win on space and views. The optimal solution is often a room-by-room combination."
      },
      {
        "q": "How long does installation take?",
        "a": "For a typical home, 1–3 days, including removal of the old frames."
      },
      {
        "q": "Do you work outside Rethymno?",
        "a": "Yes — we deliver projects across Crete, from our production facility in Rethymno."
      }
    ],
  ...
  },
  {
    ...
    "date": "2026-07-01",
    "dateModified": "2026-07-11",
    "image": "/images/pergola_crete_1776112148406.webp",
    "relatedSlugs": [
      "exoikonomo-2026-koufomata-kriti",
      "energeiaka-koufomata-alouminiou-ti-na-prosexete"
    ],
    ...
    "faqEL": [
      {
        "q": "Γιατί οι τιμές ανά τετραγωνικό είναι παραπλανητικές;",
        "a": "Γιατί ένα μικρό παράθυρο κοστίζει αναλογικά περισσότερο ανά m² από μια μεγάλη μπαλκονόπορτα (ίδιος μηχανισμός, λιγότερα τετραγωνικά). Μόνο η αναλυτική κοστολόγηση ανά τεμάχιο έχει νόημα."
      },
      {
        "q": "Η επιμέτρηση χρεώνεται;",
        "a": "Όχι — η επιμέτρηση και η τεχνική μελέτη στο Ρέθυμνο και την ευρύτερη περιοχή γίνονται χωρίς χρέωση."
      },
      {
        "q": "Πόσο κρατάει μια σοβαρή κατασκευή αλουμινίου;",
        "a": "Με σωστή βαφή και τοποθέτηση, δεκαετίες — το αλουμίνιο δεν σαπίζει, δεν στραβώνει και δεν χρειάζεται συντήρηση πέρα από καθαρισμό."
      },
      {
        "q": "Παίρνετε τα παλιά κουφώματα;",
        "a": "Ναι, αναλαμβάνουμε αποξήλωση και απομάκρυνση — το αλουμίνιο ανακυκλώνεται 100%."
      }
    ],
    "faqEN": [
      {
        "q": "Why are per-square-metre prices misleading?",
        "a": "Because a small window costs proportionally more per m² than a large balcony door (same mechanism, fewer square metres). Only itemised, per-unit costing is meaningful."
      },
      {
        "q": "Is the survey charged?",
        "a": "No — on-site measurement and technical assessment in Rethymno and the wider area are free of charge."
      },
      {
        "q": "How long does a quality aluminium fabrication last?",
        "a": "With proper coating and installation, decades — aluminium doesn't rot, warp, or require maintenance beyond cleaning."
      },
      {
        "q": "Do you take away the old frames?",
        "a": "Yes, we handle removal and disposal — aluminium is 100% recyclable."
      }
    ],
    "category": "Οδηγός Αγοράς",
  ...
  },
  {
    ...
    "date": "2026-07-01",
    "dateModified": "2026-07-11",
    "image": "/images/aluminum_doors_patio_1776112180417.webp",
    "relatedSlugs": [
      "times-koufomata-alouminiou-odigos-kostous",
      "energeiaka-koufomata-alouminiou-ti-na-prosexete"
    ],
    ...
    "faqEL": [
      {
        "q": "Χρειάζεται οικοδομική άδεια για αντικατάσταση κουφωμάτων;",
        "a": "Για απλή αντικατάσταση στις ίδιες διαστάσεις, κατά κανόνα όχι. Αν αλλάζουν διαστάσεις ανοιγμάτων, απαιτείται έγκριση εργασιών μικρής κλίμακας — σας καθοδηγούμε."
      },
      {
        "q": "Θα χαλάσουν οι σοβάδες και τα μάρμαρα;",
        "a": "Με προσεκτική αποξήλωση, οι φθορές είναι ελάχιστες έως μηδενικές. Όπου χρειαστεί μερεμέτι, το γνωρίζετε από την προσφορά — όχι εκ των υστέρων."
      },
      {
        "q": "Μπορώ να μένω στο σπίτι κατά την τοποθέτηση;",
        "a": "Ναι. Δουλεύουμε ανά δωμάτιο και κάθε βράδυ το σπίτι κλείνει κανονικά."
      },
      {
        "q": "Τι γίνεται με ρολά και σίτες;",
        "a": "Αντικαθίστανται ή προστίθενται στο ίδιο έργο — συνήθως ενσωματωμένα κουτιά ρολών με θερμομόνωση."
      }
    ],
    "faqEN": [
      {
        "q": "Is a building permit required?",
        "a": "For like-for-like replacement in the same dimensions, generally no. If opening dimensions change, a small-scale works approval is required — we guide you through it."
      },
      {
        "q": "Will plaster and marble be damaged?",
        "a": "With careful removal, damage is minimal to zero. Where patching is needed, you know it from the quotation — not after the fact."
      },
      {
        "q": "Can I stay in the house during installation?",
        "a": "Yes. We work room by room and the house closes up normally every evening."
      },
      {
        "q": "What about roller shutters and insect screens?",
        "a": "Replaced or added within the same project — usually with insulated, integrated shutter boxes."
      }
    ],
    "category": "Οδηγός Αγοράς",
