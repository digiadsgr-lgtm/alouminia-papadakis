export const articles = [

  {
    ...
    contentEL: `
      ...
      <div class="overflow-x-auto my-8">
        <table class="w-full text-left border-collapse bg-white/5 rounded-xl overflow-hidden">
          ...
          <tbody class="divide-y divide-white/10">
            ...
            <tr><td class="p-4 font-bold text-gray-400">2. Διάρκεια Ζωής</td><td class="p-4">50+ χρόνια (το αλουμίνιο δεν φθείρεται)</td><td class="p-4">10-15 χρόνια (το πανί χρειάζεται αλλαγή)</td></tr>
            ...
            <tr><td class="p-4 font-bold text-gray-400">5. Στεγανότητα τον Χειμώνα</td><td class="p-4">Απόλυτη (100% αδιαβροχοποίηση)</td><td class="p-4">Καλή, αλλά το πανί συγκρατεί υγρασία/ρύπους</td></tr>
            <tr><td class="p-4 font-bold text-gray-400">6. Απαιτήσεις Συντήρησης</td><td class="p-4">Μηδενικές (απλό πλύσιμο με νερό)</td><td class="p-4">Συχνός καθαρισμός πανιού, λίπανση οδηγών</td></tr>
      ...
      <p>Στη νότια και βόρεια Κρήτη, ένα σύστημα με πανί θα δοκιμαστεί σκληρά από τους αέρηδες. Η βιοκλιματική πέργκολα αλουμινίου, εξοπλισμένη με αισθητήρες αέρα, προσαρμόζει τις περσίδες της ώστε να μην καταπονείται. Επιπλέον, μετατρέπει μια απλή βεράντα σε ένα πραγματικό «δωμάτιο» που μπορείτε να χρησιμοποιείτε 365 μέρες τον χρόνο, προστατευμένο από βροχή και καύσωνα (όπως εξηγήσαμε και στον <a href="/el/blog/exoikonomo-2026-koufomata-kriti">Οδηγό Εξοικονομώ 2026</a>, η ενεργειακή θωράκιση είναι το παν).</p>
      ...
      <div class="mt-12 p-8 bg-gradient-to-r from-red-900/40 to-black border border-red-500/20 rounded-2xl text-center">
        <h3 class="text-2xl font-bold text-white mb-4">Ενδιαφέρεστε για Βιοκλιματική Πέργκολα στην Κρήτη;</h3>
        <p>Σε κάθε περίπτωση, εμείς στην <a href="/el">Αλουμίνια Παπαδάκης</a>, είμαστε στη διάθεσή σας για μια δωρεάν μελέτη στον χώρο σας, προκειμένου να σχεδιάσουμε μαζί την ιδανική λύση, χωρίς καμία δέσμευση.</p>
        <a href="tel:2831023897" class="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-full transition-transform hover:scale-105 shadow-xl">
          Καλέστε μας: 28310 23897
        </a>
      </div>
    `,
    contentEN: `
      ...
      <p>The <strong><a href="/en/systimata-alumil/smartia-pergoles">bioclimatic pergola</a></strong> is made 100% of aluminum (frame and movable louvers). The louvers rotate to offer natural ventilation (bioclimatic action) and when closed, they perfectly seal against water, which drains through hidden gutters in the columns.</p>
      ...
      <div class="overflow-x-auto my-8">
        <table class="w-full text-left border-collapse bg-white/5 rounded-xl overflow-hidden">
          ...
          <tbody class="divide-y divide-white/10">
            ...
            <tr><td class="p-4 font-bold text-gray-400">2. Lifespan</td><td class="p-4">50+ years (aluminum does not degrade)</td><td class="p-4">10-15 years (fabric needs replacement)</td></tr>
            ...
            <tr><td class="p-4 font-bold text-gray-400">5. Winter Watertightness</td><td class="p-4">Absolute (100% waterproofing)</td><td class="p-4">Good, but fabric retains moisture/dirt</td></tr>
            <tr><td class="p-4 font-bold text-gray-400">6. Maintenance Needs</td><td class="p-4">Zero (simple washing with water)</td><td class="p-4">Frequent fabric cleaning, track lubrication</td></tr>
      ...
      <h2>The Real Cost in the Long Run</h2>
      <p>A tent pergola has a lower initial installation cost. However, in the harsh climate of Crete, the PVC fabric usually requires replacement every 10-12 years due to sun and salt wear. Additionally, the motor and tracks require more frequent maintenance.</p>
      <p>On the other hand, the bioclimatic pergola is a "one-time" investment. The aluminum does not rust, the Seaside Class coating remains intact, and its structural integrity offers a lifetime guarantee. If you divide the cost by the years of use, the bioclimatic pergola ends up being cheaper.</p>

      <h2>Our Verdict for Crete</h2>
      <p>If you are looking for a temporary or budget solution for a rented space, the tent pergola is a decent choice. However, if you are building your permanent residence or a luxury hotel that you want to upgrade aesthetically and functionally without future costs, the <strong>bioclimatic pergola is a one-way street</strong>.</p>
      
      <p>In any case, we at <a href="/en">Papadakis Aluminium</a> are at your disposal for a free on-site study, to design together the ideal solution, without any commitment.</p>
    `
  },
  {
